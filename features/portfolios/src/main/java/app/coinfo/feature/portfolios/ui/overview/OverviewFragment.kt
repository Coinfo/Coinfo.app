package app.coinfo.feature.portfolios.ui.overview
...
import app.coinfo.feature.portfolios.databinding.FragmentOverviewBinding
import app.coinfo.feature.portfolios.model.UIPortfolio
import app.coinfo.feature.portfolios.ui.details.portfolio.PortfolioDetailsFragment
...
class OverviewFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
        if (item.itemId == R.id.action_add_portfolio) {
            findNavController().navigate(R.id.destination_add_portfolio)
            true
